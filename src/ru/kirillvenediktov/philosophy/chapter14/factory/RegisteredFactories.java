...
class FuelFilter extends Filter {
    ...
    public static class Factory
            implements ru.kirillvenediktov.philosophy.chapter14.factory.Factory<FuelFilter> {
...
class AirFilter extends Filter {
    ...
    public static class Factory
            implements ru.kirillvenediktov.philosophy.chapter14.factory.Factory<AirFilter> {
...
class CabinFilter extends Filter {
    ...
    public static class Factory
            implements ru.kirillvenediktov.philosophy.chapter14.factory.Factory<CabinFilter> {
...
class OilFilter extends Filter {
    ...
    public static class Factory
            implements ru.kirillvenediktov.philosophy.chapter14.factory.Factory<OilFilter> {
...
class FanBelt extends Bellt {
    ...
    public static class Factory
            implements ru.kirillvenediktov.philosophy.chapter14.factory.Factory<FanBelt> {
...
class GeneratorBelt extends Bellt {
    ...
    public static class Factory
            implements ru.kirillvenediktov.philosophy.chapter14.factory.Factory<GeneratorBelt> {
...
class PowerSteeringBelt extends Bellt {
    ...
    public static class Factory
            implements ru.kirillvenediktov.philosophy.chapter14.factory.Factory<PowerSteeringBelt> {
